#############################################################
# PROJECT              : INTRA FUNCTION CODE GENERATOR README
# DESCRIPTION          : Phase 3 of Compiler Construction
...
# FUTURE PHASES        : 1.INTER-FUNCTION CODE GENERATOR
#############################################################

I have used my own parser for the project. 
...
---------------------------
	...
	1. LOGIC 
		...
		Specifically, the code-generator does 8 iterations, each performed by the functions detailed in DATA STRUCTURE section. 
